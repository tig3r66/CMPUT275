/*
    Serial port class specifically set up for communication with Arduino
    Mega2560 in the Ubuntu VM used in CMPUT 275
...
public:
    ...
    // milliseconds.
    // If timeout <= 0, then no timeout will be used: it will wait indefinitely
    // until '\n' is read.
